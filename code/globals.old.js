...
buildingPlans = {
    ...
    longDistanceHarvester: [{
        ...
        },
        {
            //Level 3 (max 800)
            minEnergy: 750,
            body: [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, CARRY, CARRY, CARRY]
        },
        {
            //Level 4 (max 1300)
            minEnergy: 1250,
    ...
    upgrader: [{
        ...
        },
        {
            //Level 6 (max 2300)
            minEnergy: 2150,
            body: [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY]
        },
        {
            //Level 7 (max 5600)
            minEnergy: 3900,
